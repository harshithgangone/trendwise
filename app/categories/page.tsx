  ...
  const fetchCategories = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Filter out any invalid categories and ensure they're from the database
        const validCategories = (data.categories || []).filter(
          (category: any) => category && category.name && typeof category.name === "string" && category.count > 0,
        )
          ...
          >
            <Card className="max-w-md mx-auto shadow-lg border-red-200">
              <CardContent className="p-6 text-center">
                ...
                <Button onClick={fetchCategories} className="bg-blue-500 hover:bg-blue-600">
